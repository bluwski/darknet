...
layer parse_yolo(list *options, size_params params)
{
    ...
    else if (strcmp(iou_loss, "aiou") == 0) l.iou_loss = AIOU;
    else l.iou_loss = IOU;
    ...
    else if (strcmp(iou_thresh_kind_str, "aiou") == 0) l.iou_thresh_kind = AIOU;
    else {
    ...
    l.track_aiou_norm = option_find_float_quiet(options, "track_aiou_norm", 0.01);
